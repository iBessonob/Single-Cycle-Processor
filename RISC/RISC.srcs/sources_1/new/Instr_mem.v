...
reg [0:31] memory[63:0]; //array of 64 instructions, each is 32 bits
...
initial begin
    ...
    memory[9] = 32'h404404b3; // sub r9, r8, r4 32'hfe
    ...
    memory[13] = 32'h007346b3; // nor r13, r6, r7 32'hf4
    memory[14] = 32'h4d34f713; // andi r14, r9, "4D3" 32'h000004D2
    memory[15] = 32'h8d35e793; // ori r15, r11, "8d3" 32'hf8d7
    memory[16] = 32'h4d26a813; // if r13 is less than 32'h000004D2 then r16 = 1 32'h00000000
    memory[17] = 32'h4d244893; // nori r17, r8, "4D2" 32'hfb2C
...
//shift right since the least 2 sig bits are for 
//accessing the instructions each instructino "block"
