...
assign Operation[2] = 1'b1 ? ((Funct3 == 3'b100) | ((Funct3 == 3'b010) & (ALUOp[0] == 1'b0)) | ((Funct7 == 7'b0100000) & (Funct3 == 3'b000) & (ALUOp == 2'b10)) ): 1'b0;
assign Operation[3] = 1'b1 ? ((Funct3 == 3'b100) & (ALUOp[0] == 1'b0)) : 1'b0;
